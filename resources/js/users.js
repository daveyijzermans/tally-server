...
class Users
{
  constructor(opts)
  {
    ...
    this.$btnUsersPopout = $('#usersPopout'); //TODO: is static

    this.tallies.on('updated', (t) => this.updateUserTallies(t));
    
    this.socket.on('admin.user.disconnect', username =>
    {
    ...
    this.socket.on('admin.users.list', users =>
    {
      ...
      this.updateUserTallies(this.tallies.getCombined());
    });
    this.$btnUsersPopout.click(event =>
    {
